...
This repository follows a **multi-service monorepo structure** to clearly separate
application orchestration from AI intelligence.
...
1. Frontend sends requests to Node.js backend
2. Backend validates input and applies rules
3. Backend optionally calls AI service
4. AI service returns structured or retrieved data
5. Backend assembles final response and returns it to frontend
